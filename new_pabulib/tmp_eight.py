...
def merge_images(list_of_names=None, size=250, show=False, ncol=1, nrow=1,
    ...
    images.append(Image.open(f'images/warszawa_2023_geo/poland_warszawa_2023_wlochy.pb.png'))
    ...
    images.append(Image.open(f'images/warszawa_2023/poland_warszawa_2023_wlochy.pb.png'))
...
if __name__ == "__main__":
    ...
    merge_images(ncol=4, nrow=2, show=True)

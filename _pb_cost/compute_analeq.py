...
def print_this_stuff(region, name, last_costs):
    pass
    ...
    if __name__ == "__main__":
        ...
        for region in regions:
            ...
            for name in NAMES[region]:
                ...
                last_costs = compute_analytical_equilibrium_of_mes(region, name)

                print_this_stuff(region, name, last_costs)
